                                            ...
                                            <Box style={{ margin: "auto" }} width={["62%", "100%"]} justifyContent={["center", "left"]} alignItems={["center", "left"]} alignContent={["center", "left"]}>
                                                ...
                                                <HStack>
                                                    <Center m="4"><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                        rounded="10"
                                                        color="white" fontSize={"1em"}> <a href="https://fashique.vercel.app/" target="_blank" without rel="noreferrer"> DEMO &nbsp;<i class="fa-regular fa-clone"></i></a></Button>
                                                    </Center>
                                                    <Box size="sm" >
                                                        <Center ><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                            rounded="10"
                                                            color="white" fontSize={"1em"}> <a href="https://github.com/Vikas23sharma/large-house-6330" target={"_blank"} without rel="noreferrer"> CODE  &nbsp;<i class="fa-brands fa-github"></i></a></Button> </Center>
                                                    </Box>
                                                </HStack>
                                        ...
                                        <Box>
                                            ...
                                            <Box style={{ margin: "auto" }} width={["62%", "100%"]} alignItems={["center", "left"]} alignContent={["center", "left"]}>
                                                ...
                                                <HStack>
                                                    <Center m="4"><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                        rounded="10"
                                                        color="white" fontSize={"1em"}> <a href="https://fff-gilt.vercel.app/" target="_blank" without rel="noreferrer"> DEMO &nbsp;<i class="fa-regular fa-clone"></i></a></Button>
                                                    </Center>
                                                    <Box size="sm" >
                                                        <Center ><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                            rounded="10"
                                                            color="white" fontSize={"1em"}> <a href="https://github.com/Shanky43/haloed-ground-8588-" target={"_blank"} without rel="noreferrer"> CODE  &nbsp;<i class="fa-brands fa-github"></i></a></Button> </Center>
                                                    </Box>
                                                </HStack>
                                        ...
                                        <Box>
                                            ...
                                            <Box style={{ margin: "auto" }} width={["62%", "100%"]} alignItems={["center", "left"]} alignContent={["center", "left"]}>
                                                ...
                                                <HStack>
                                                    <Center m="4"><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                        rounded="10"
                                                        color="white" fontSize={"1em"}> <a href="https://lustrous-gumption-92216f.netlify.app/" target="_blank" without rel="noreferrer"> DEMO &nbsp;<i class="fa-regular fa-clone"></i></a></Button>
                                                    </Center>
                                                    <Box size="sm" >
                                                        <Center ><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                            rounded="10"
                                                            color="white" fontSize={"1em"}> <a href="https://github.com/Shanky43/tedious-advertisement-2369" target={"_blank"} without rel="noreferrer"> CODE  &nbsp;<i class="fa-brands fa-github"></i></a></Button> </Center>
                                                    </Box>
                                                </HStack>
                                        ...
                                        <Box>
                                            ...
                                            <Box style={{ margin: "auto" }} width={["62%", "100%"]} alignItems={["center", "left"]} alignContent={["center", "left"]}>
                                                ...
                                                <HStack>
                                                    <Center m="4"><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                        rounded="10"
                                                        color="white" fontSize={"1em"}> <a href="https://shopdigital.netlify.app/" target="_blank" without rel="noreferrer"> DEMO &nbsp;<i class="fa-regular fa-clone"></i></a></Button>
                                                    </Center>
                                                    <Box size="sm" >
                                                        <Center ><Button bgColor={"#e4002b"} _hover={{ bg: "#e4002b" }}
                                                            rounded="10"
                                                            color="white" fontSize={"1em"}> <a href="https://github.com/Shanky43/vivacious-silk-4958" target={"_blank"} without rel="noreferrer"> CODE  &nbsp;<i class="fa-brands fa-github"></i></a></Button> </Center>
                                                    </Box>
                                                </HStack>
                                            </Box>
                                            {/* teckStack */}
